...
class StoresAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'postcode', 'city', 'country', 'rating', 'ratings',
...
class DeliveriesAdmin(admin.ModelAdmin):
    ...
    list_display = ('store', 'label', 'price', 'min_dist', 'max_dist',
                    'min_total', 'max_total',)
    list_display_links = ('store', 'label',)
    search_fields = ('store__name', 'store__address_line_1',
                     'store__postcode', 'label',)


###############################################################################
class StoreReviewsAdmin(admin.ModelAdmin):
    """ Registers Store Reviews (stores_storereviews) table to the
    admin page """
    list_display = ('store', 'user', 'rating', 'review_date',)
    list_display_links = ('store',)
    search_fields = ('store__name', 'store__address_line_1', 'user__username',
                     'user__email', 'rating',)
