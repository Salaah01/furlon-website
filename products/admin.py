...
class ColourFamiliesAdmin(admin.ModelAdmin):
    """ Registers Colour Families (products_colourfamilies) table to the admin page """
    list_display = ('name',)
...
class SubCategoriesAdmin(admin.ModelAdmin):
    """ Registers Sub Categories (products_subcategories) table to the admin page """ 
...
class ProductsAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'store', 'price', 'rating', 'room', 'category', 'sub_categories',
                    'colour', 'inventory', 'status', 'upload_date','last_purchase_date',)
    list_display_links = ('name',)
...
class ProductReviewsAdmin(admin.ModelAdmin):
    ...
    list_display_links = ('product', )
    search_fields = ('product__name', 'store__name', 'store__name', 'user__first_name',
                    'user__last_name', 'user__email', 'user__username',)
