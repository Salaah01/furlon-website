...
class CustomerDetailsAdmin(admin.ModelAdmin):
    """ Registers Customer Details (accounts_customerdetails) table to the admin page """ 
    ...
    search_fields = ('user_id__id', 'user_id__first_name', 'user_id__last_name', 'user_id__email',
                    'user_id__username') 
...
class StoreUserAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user_id__first_name', 'user_id__last_name', 'user_id__email',
                    'user_id__username', 'store_id__name', 'store_id__id', 'store_id__postcode',) 
